...
import org.firstinspires.ftc.vision.apriltag.AprilTagDetection;   // <<< NEW
...
public class BlueTeleOp extends LinearOpMode {
    ...
    public static double kP1 = 0.015;
    public static double kP2 = 0.015;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.right_bumper) {
                ...
                if (output_power1 > 0.8) output_power1 = 0.8;
                if (output_power2 > 0.8) output_power2 = 0.8;
                if (output_power1 < 0) output_power1 = 0;
                if (output_power2 < 0) output_power2 = 0;
