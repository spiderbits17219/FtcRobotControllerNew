...
@Autonomous(name="moveTurnCloseAuto", group="Autonomous")
public class moveTurnCloseAuto extends LinearOpMode {
...
//    public double shooterPower1 = 0.8, shooterPower2 = -0.8;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        shooterServo.setPosition(0.6); // closed pos
        intakeServo.setPosition(0.7); // closed pos

        encoderDrive(0.5, -15); // move back from shooter wall (move forward intake side)
