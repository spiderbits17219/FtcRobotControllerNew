...
@Autonomous(name="blueFarAuto6", group="Autonomous")
public class blueFarAuto6 extends LinearOpMode {
...
//    public double shooterPower1 = 0.8, shooterPower2 = -0.8;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        encoderDrive(0.5, 90); // move forward
        turnDrive(0.5, 10);      // turn right
        encoderDrive(0.5, 4);   //half a tile
